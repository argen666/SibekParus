 ...
 */
public class OrdersSpecFragment extends SwipeToRefreshList implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static OrdersSpecFragment newInstance(long invoiceId) {
        final OrdersSpecFragment fragment = new OrdersSpecFragment();

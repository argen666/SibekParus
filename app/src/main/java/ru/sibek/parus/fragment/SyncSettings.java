...
public class SyncSettings extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private static final String KEY_AUTO_SYNC = "ru.sibek.parus.KEY_AUTO_SYNC";

    private static final String KEY_AUTO_SYNC_INTERVAL = "ru.sibek.parus.KEY_AUTO_SYNC_INTERVAL";
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        if (TextUtils.equals(KEY_AUTO_SYNC, key)) {
            if (prefs.getBoolean(key, false)) {
                ...
                ContentResolver.removePeriodicSync(ParusApplication.sAccount, ParusAccount.AUTHORITY, new Bundle());
            }
            ...
            ContentResolver.addPeriodicSync(
                    ParusApplication.sAccount, ParusAccount.AUTHORITY,
